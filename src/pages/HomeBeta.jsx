...
export const HomeBeta = () => {
  ...
  return (
      <div className="relative m-auto flex w-screen flex-col justify-center bg-mat_grey p-0">
        <section className="flex min-h-screen min-w-full flex-col justify-center gap-4 overflow-hidden p-0 relative" style={{ marginTop: `-${headerHeight}px` }}>
          <BgVideo src={LaserVideo} freezeTime={10} />
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col gap-4 p-2 text-center">
            ...
            <Link to="/gallery" className="self-center rounded-4xl bg-red-700 px-4 py-2 font-sans font-thin text-white shadow-sm hover:bg-red-600">
              gallery
            </Link>
          </div>
        </section>
          ...
          <div className="flex flex-col justify-center gap-2">
            <div className="rounded-lg w-fit self-center backdrop-blur-lg">
              <p className="self-center p-2 text-center font-serif text-2xl text-cad_grey">
                I run my engraving business from my own workshop here in Sacramento. All your orders are handled personally
                by me. If it's made of metal ask me about it.
              </p>
            </div>
          </div>
        </section>
