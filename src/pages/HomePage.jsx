  ...
  return (
      ...
      >
        ...
        <div className={'h-screen'}>
          ...
          <div className={"p-12 flex text-center w-full items-center"}>
            <h2 className="text-2xl sm:text-3xl w-full md:text-4xl md:p-2 font-poppins text-center items-center font-semibold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-700">
              Why Laser Engraving?
            </h2>
          </div>
