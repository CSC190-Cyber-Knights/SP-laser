          ...
          <div className={"grid-rows-4"}>
              <div className={"grid-rows-4"}>
                  ...
                  <ul id={'galleryID'} className={"flex-container"}>
                      ...
                      <img src={"https://firebasestorage.googleapis.com/v0/b/laserengraving-9a35a.appspot.com/o/images%2FIMG_0561.jpeg?alt=media&token=7581cb12-4c21-46ae-9388-0759aba98cc2"} alt="Image Not Found" className={"w-1/6 thermos"}/>
