...
const AboutMe_old = () => {
  return (<div 
      className={"flex flex-col font-inter items-center m-auto p-2 bg-[#ffffff] max-w-7xl justifyContent: 'flex-end' " //css code
  ...
  >
    ...
    >
      <h1
          className={"text-slate-500 md:self-start font-semibold tracking-tighter drop-shadow sm:text-start text-center "}
      >
    ...
    {/* Heading 2 */}
    <h2
        className={"entry-title font-bold pt-6 pb-8 text-2xl items-center w-9/12"}
    >
    ...
    >
      <div
          className={"whitespace-pre-line font-poppins"}
      >
        <p
            className={"text-balance text-base indent-8 p-2 text-sm text-neutral-700 sm:font-medium"}>
        ...
        <p
          ...
          to
          firearms, or to personalized messages to that special someone, Michael's business revolves around
          transforming
