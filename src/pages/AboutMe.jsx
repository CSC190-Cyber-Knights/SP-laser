  ...
  return (
    <div style={{backgroundColor: '#003153'}}>
      ...
      <div style={{display: 'flex', alignItems: 'center'}}>
        <div>
          {/* Start of body of About Me */}
          <div style={{margin: '50px'}}>
            <p
              style={{color: '#FFFFFF'}}
              className="mt-2 w-8/12 self-center text-balance p-2 text-center indent-8 text-base text-sm italic text-neutral-500 sm:font-medium md:w-8/12 md:text-lg"
            >
        ...
        <div style={{alignItems: 'center', border: '2px solid #ccc', padding: '10px', borderRadius: '5px'}}>
          ...
          <div className="flex flex-row whitespace-pre-line">
            ...
            <br></br>
            <div className="whitespace-pre-line ps-8 pt-6 font-semibold">
              <ButtonLink to={'https://www.twitter.com/'}>Twitter </ButtonLink>
            </div>
          </div>
        </div>
      </div>
