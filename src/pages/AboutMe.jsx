...
const AboutMe = () => {
  return (
    <div style={{backgroundColor: '#003153', textAlign: 'center'}}>
      ...
      {/* Rest of the content */}
      <div style={{display: 'flex', alignItems: 'center', flexDirection: 'column', textAlign: 'justify'}}>
        <div style={{margin: '50px', maxWidth: '800px'}}>
          <p
            style={{color: '#FFFFFF'}}
            className="mt-2 p-2 text-base text-sm italic text-neutral-500 sm:font-medium md:text-lg"
          >
